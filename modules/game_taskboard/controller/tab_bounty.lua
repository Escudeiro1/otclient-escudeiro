...
function TaskBoardController:changeDifficulty(event)
    ...
    -- diffId is the HTML dropdown value (1=Beginner..4=Master); do NOT subtract 1 here —
    -- the conversion to 0-based is already done inside bountyTaskAction → toServerDifficulty()
    -- in src/client/game.cpp:1831.
