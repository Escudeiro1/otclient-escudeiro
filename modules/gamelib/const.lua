...
-- This deployment's own RSA keypair (public modulus), replacing the OT
-- community's long-circulated shared default. Must match the private key
-- deployed as the canary server's key.pem, or the login handshake fails to
-- decrypt. See SECURITY_AUDIT.md finding 3.3.1.
OTSERV_RSA = '12750859015543070974265684410384568784493140052793634561069296834' ..
    '34899570076947988956341195436593868105902966943481209457250399880' ..
    '25061918083455598012036769113529427735013561003922772604605008128' ..
    '84203877208430940887394727782617507581630307098077183758872911809' ..
    '2682657142986559109747407776487302593884868396847'
