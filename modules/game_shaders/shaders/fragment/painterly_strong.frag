// Same Kuwahara filter as painterly.frag, with the neighbourhood spread out
...
void main() {
    vec2 p = vec2(u_MapZoom / u_Resolution.x, u_MapZoom / u_Resolution.y) * PAINTERLY_SPREAD;
